...
pub struct TrackStreamQuery {
    ...
    pub encoded_track: Option<String>,
    /// Raw YouTube video ID (alternative to encodedTrack, YouTube only).
    pub video_id: Option<String>,
    /// YouTube itag to select a specific format.
    pub itag: Option<i64>,
    /// Specific YouTube client name (e.g. "ANDROID", "TV"). WEB is always excluded.
