...
pub struct JioSaavnStreamContext {
    pub client: Arc<reqwest::Client>,
    pub secret_key: Vec<u8>,
    pub proxy: Option<crate::configs::HttpProxyConfig>,
}

impl JioSaavnStreamContext {
    pub fn decrypt_url(&self, encrypted: &str) -> Option<String> {
...
impl JioSaavnSource {
    ...
    pub fn stream_context(&self) -> Arc<JioSaavnStreamContext> {
        Arc::new(JioSaavnStreamContext {
